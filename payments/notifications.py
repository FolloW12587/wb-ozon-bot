...
async def notify_user_about_referal_free_subscription(user_id: int, is_invited: bool):
    ...
    if is_invited:
        text = """
Вам начислены *14 дней бесплатной подписки* со всеми функциями 🚀

Это подарок за участие в нашей реферальной программе 🤝
Наслаждайтесь отслеживанием скидок без ограничений!
"""
    else:
        text = """
Ваш друг принял приглашение и присоединился к боту 🎉

В качестве благодарности мы начислили вам *14 дней бесплатной подписки* 🚀
